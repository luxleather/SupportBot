...
async def on_message(message):
	...
	if message.content.startswith('?help'):
		...
		msg = "TELOS 3.0.1 blockchain works on port 8051. You don't need to do any additional steps, just run the wallet. If for some reason the wallet won't sync check if you have the latest TELOS wallet. To help you sync faster you can also download the bootstrap: <https://drive.google.com/file/d/1R0dayAfBI-HsQ28dgEdpqGJ79itiRcFj/view?usp=sharing>".format(message)
		await message.channel.send(msg)
		...
		msg = "If you want simplified installation of maternode please follow detailed guide from Telosgreen official forum: <https://forum.teloscoin.org/forum/education/513-teloscoin-masternode-installation-tutorial>".format(message)
		await message.channel.send(msg)
		...
		msg = "The TelosCoin December fork happens at block 1276502. This fork will see the following important changes: -masternodes/staking split changing from 80(mn)/20(stk) to 70(mn)/30(stk)".format(message)
		await message.channel.send(msg)		
